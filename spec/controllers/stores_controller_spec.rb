...
RSpec.describe Api::V1::StoresController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'Store Test 1', address: 'Road Test' }
  }

  let(:invalid_attributes) {
    { name: 'Store Test 1', address: 'Ab' }
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new store" do
        ...
        expect(response.location).to eq(api_v1_store_url(Store.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { name: 'New Store Name 1', address: 'Address New 2' }
      }
